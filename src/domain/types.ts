...
export type Message = { id: number; conversation_id?: string; sender_id: string; body: string; image_path: string | null; media_path?: string | null; media_type?: "image" | "video" | null; media_once?: boolean; media_opened_at?: string | null; reply_to: number | null; reply?: { id: number; body: string; image_path: string | null; media_type?: "image" | "video" | null; media_once?: boolean; sender_id: string } | null; client_id: string; created_at: string };
