    ...
    <div className="settings-page settings-pro">
      ...
      <div className="settings-layout">
        ...
        <section className="panel settings-content">
          ...
          {section === "help" && <><SettingsTitle title="Bantuan dan informasi" text="Informasi singkat tentang pengalaman Octgram." /><div className="about-octgram"><span className="about-mark">O</span><div><h2>Octgram</h2><p>Ruang berbagi foto, percakapan, dan siaran langsung dengan identitas biru khas Octgram.</p><small>Versi aplikasi 2.1.0</small></div></div><div className="settings-security-note"><ShieldCheck size={19} /><p>Foto dan video di percakapan disimpan secara privat melalui Supabase, dikompresi ke format AVIF agar hemat kuota, dan tersimpan permanen di riwayat chat.</p></div></>}
        </section>
      </div>
    </div>
  );
