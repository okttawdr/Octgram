...
export const api = {
  ...
  sendMessage: (conversationId: string, body: string, requestId: string, opts?: { imagePath?: string | null; replyTo?: number | null }) => request<Message>(`/conversations/${conversationId}/messages`, { method: "POST", body: { body, requestId, imagePath: opts?.imagePath ?? null, replyTo: opts?.replyTo ?? null } }),
